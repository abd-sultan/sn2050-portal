...
import InfoRequestsLineChart from '___src/app/portal/(admin)/components/charts/InformationRequest';
import ProjectDistributionPieChart from '___src/app/portal/(admin)/components/charts/ProjectDistribution';
import RegistrationsBarChart from '___src/app/portal/(admin)/components/charts/Registrations';
import RequestStatusStackedBarChart from '___src/app/portal/(admin)/components/charts/RequestStatus';
import {
  Card,
  CardContent,
  CardHeader,
